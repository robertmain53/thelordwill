...
} from "@/app/bible-travel/[slug]/page";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const alternates = buildAlternates(`/bible-travel/${slug}`, locale);
...
export default async function LocaleBibleTravelPage({ params }: PageProps) {
    ...
    <>
      {!isTranslated && (
        <LocaleFallbackBanner
          locale={locale}
          currentPath={`/${locale}/bible-travel/${slug}`}
        />
      )}
